...
#define lua_autostruct_push_member_name(L, type, cstruct, member) lua_autostruct_push_member_typeid(L, lua_typeid(type), cstruct, member)
...
#define lua_autostruct_pop_member_name(L, type, cstruct, member) lua_autostruct_pop_member_typeid(L, lua_typeid(type), cstruct, member)
...
#define lua_autostruct_add_member(L, type, member, member_type) lua_autostruct_add_member_typeid(L, lua_typeid(type), #member, lua_typeid(member_type), ((long)&(((type*)0)->member)))
